...
<head>
  ...
  <link href="<?php echo asset('sweetaler2/dist/sweetalert2.css')?>" rel="stylesheet">
  <link href="<?php echo asset('sweetaler2/css/animate.css')?>" rel="stylesheet">
  <script src="<?php echo asset('sweetaler2/dist/sweetalert2.js')?>"></script>
	<script src="<?php echo asset('sweetaler2/js/codigo.js')?>"></script>
</head>
      ...
      <div class="sidebar-wrapper" id="sidebar-wrapper">
        <ul class="nav">
          ...
          <li class = "<?php if($menu==2) echo 'active' ?> ">
            <a href="./adminProductos">  <i class="now-ui-icons design_bullet-list-67"></i>  <p>ADMIN PRODUCTOS</p>  </a>
          </li>
          <li> 
